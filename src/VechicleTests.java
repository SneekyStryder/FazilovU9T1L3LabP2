public class VechicleTests
{
  ...
  //  myTaxi4.printInfo();
    ...
    Vehicle vehicle = new Vehicle("LMANS", 2.75, 3, 5000);
    Car car = new Car("WMANS", 3, 3, 2000, true);
    Truck truck = new Truck("NOBTHES", 2.22, 4, 20000, 3, false);
    Taxi taxi = new Taxi("PULLUP", 1, 7, 212, true, 4090,7);

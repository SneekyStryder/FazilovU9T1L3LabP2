public class Truck extends Vehicle
{
  ...
  public Truck(String licensePlate, double tollFee, int passengers, int totalMiles, int axles, boolean hasTrailer)
  {
    super(licensePlate, tollFee, passengers, totalMiles);
    this.axles = axles;
